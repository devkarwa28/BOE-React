        ...
        <div className="container">
            <div className="row justify-content-md-center justify-content-lg-start ">
                <div className="col-md-8 col-lg-5">
                    ...
                    <div className="d-sm-flex d-lg-block justify-content-sm-center">
                    <button>
                        About Us
                    </button>
                    </div>
